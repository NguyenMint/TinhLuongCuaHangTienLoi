...
export const UpdateDependentPersonForm = ({
  ...
  const [form, setForm] = useState({
    MaNPT:dependentPerson.MaNPT,
    HoTen: dependentPerson.HoTen,
    NgaySinh: dependentPerson.NgaySinh,
    DiaChi: dependentPerson.DiaChi,
    SoDienThoai: dependentPerson.SoDienThoai || "",
    CCCD: dependentPerson.CCCD || "",
    TruongHopPhuThuoc: dependentPerson.TruongHopPhuThuoc,
    QuanHe: dependentPerson.QuanHe
  });
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Update thông tin người phụ thuộc</h3>
          <button
            onClick={() => {
              setShowModalUpdate(false);
            }}
